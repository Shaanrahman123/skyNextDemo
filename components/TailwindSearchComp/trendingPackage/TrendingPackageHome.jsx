...
const SkeletonLoader = () => {
  return (
    <div className="flex bg-gray-300 animate-pulse space-x-4 flex-shrink-0 relative w-full aspect-w-5 aspect-h-5 sm:aspect-h-6 h-64 rounded-2xl overflow-hidden group"></div>
  );
};
