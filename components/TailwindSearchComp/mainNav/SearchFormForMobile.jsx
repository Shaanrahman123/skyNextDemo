                    ...
                    >
                      ...
                      <div className="flex-1 pt-3 px-1.5 sm:px-4 flex overflow-hidden">
                        <Tab.Panels className="flex-1 overflow-y-auto hiddenScrollbar py-4">
                          ...
                          <Tab.Panel>
                            <div className="transition-opacity animate-[myblur_0.4s_ease-in-out]">
                              <HolidaySearchFormMobile
                                ref={holidaySearchFormRef}
                              />
                            </div>
                          </Tab.Panel>
                          <Tab.Panel>
                          ...
                          <Tab.Panel>
                            <div className="transition-opacity animate-[myblur_0.4s_ease-in-out]">
                              ...
                              {flightType === "oneway" ? (
                                <OnewayformMobile ref={onewaySearchFormRef} />
                              ) : (
                                <ReturnFormMobile ref={returnSearchFormRef} />
                              )}
                            </div>
                          </Tab.Panel>
                        </Tab.Panels>
