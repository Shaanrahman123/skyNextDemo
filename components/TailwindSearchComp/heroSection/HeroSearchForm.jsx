...
const HeroSearchForm = ({
        ...
        {tabs.map((tab) => {
          ...
          return (
            <li
              ...
              className={`flex-shrink-0 flex items-center cursor-pointer text-sm lg:text-lg font-medium ${
  ...
  return (
    <div
      className={`nc-HeroSearchForm w-full max-w-6xl md:py-2 lg:py-0 ${className}`}
    >
      {renderTab()}
      {renderForm()}
    </div>
