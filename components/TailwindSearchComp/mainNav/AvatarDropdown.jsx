    ...
    <Popover className={`AvatarDropdown relative flex ${className}`}>
      {({ open, close }) => (
        <>
          ...
          >
            <h4 className="font-semibold text-base mb-0">Shaan Rahman</h4>
          ...
          >
            <Popover.Panel className="absolute z-10 w-screen max-w-[260px]  top-full -right-10 sm:right-0 sm:px-0">
