...
const HolidaySearchFormMobile = forwardRef((props, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    handleSubmit: async () => {
      if (selectedFrom) {
        router.push(`/holidaypackages/cities/${selectedFrom}`);
      }
    },
  }));
    ...
    return (
      ...
      >
        {!isActive ? (
          ...
          <HolidayLocationMobile onLocationSelect={handleLocationSelect} />
        )}
      </div>
    );
  };
    ...
    return (
      ...
      >
        {!isActive ? (
          ...
          <HolidayDateRangeMobile onDateChange={handleDateChange} />
        )}
      </div>
    );
  };
